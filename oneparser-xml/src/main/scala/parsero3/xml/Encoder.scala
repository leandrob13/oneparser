...
object Encoder extends EncoderDerivation {
  ...
  def apply[T](given c: Encoder[T]): Encoder[T] = c
  ...
  given optionEncoder[T](given tx: Encoder[T]): Encoder[Option[T]] = 
  ...
  given listEncoder[T]: (tx: Encoder[T]) => Encoder[List[T]] =
    new Encoder[List[T]] {
  ...
  given mutableSeqEncoder[T]: (tx: Encoder[T]) => Encoder[Seq[T]] =
    new Encoder[Seq[T]] {
